        ...
        <div className="container-fluid verify-certificate-wrapper">
            {
                ...
                <>
                    ...
                    <>
                        ...
                        <h5 className="text-center">Verify a vaccination certificate</h5>
                        ...
                        <Container className="mt-5 p-4 mb-5">
                            ...
                            <ol className="verify-steps">
                                <li>Visit <a href="https://cnuis2cool.github.io/validate-vaccine-certificate">https://cnuis2cool.github.io/validate-vaccine-certificate</a></li>
                            ...
                            <p>In case you need any clarification or support, contact <a href="mailto:srinivas.panuganti@hexagon.com">Srinivas.Panuganti@hexagon.com</a></p>
                        </Container>
                    </>}
                    {showScanner &&
                    <>
